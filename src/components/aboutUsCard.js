export default function AboutUsCard(props) {
  return (
    <div className="bg-light-peach text-center md:rounded-2xl overflow-hidden lg:flex lg:items-center">
      <img alt="image" className="w-full md:hidden" src={props.mobileImage}></img>
      <img alt="image" className="w-full hidden md:block lg:hidden" src={props.tabImage}></img>
      <img alt="image" className={`${props.isRight?"lg:order-2":""} w-full hidden lg:block lg:w-2/5`} src={props.desktopImage}></img>
