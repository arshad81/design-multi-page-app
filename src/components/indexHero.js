...
export default function IndexHero() {
  return (
    <div>
    <div className="sm:mx-10 max-w-7xl xl:mx-auto bg-peach text-center text-white pt-20 overflow-hidden relative z-10 lg:rounded-xl lg:flex lg:justify-between lg:items-start lg:text-start lg:ps-24 lg:py-36">
      <img
      ...
      <div className="px-6 lg:w-1/2 z-10 relative">
        <p className="text-3xl lg:text-5xl lg:leading-[48px] font-medium">
      ...
      <img
        className="translate-y-1/4 -mt-50p -mt-30p mx-auto z-20 relative lg:hidden"
        src={mobileImage}
      ></img>
      <img
