...
export default function CategoryCard(props) {
  return (
    <Link to={props.path}>
      <div className="rounded-2xl h-64 lg:min-h-64 lg:h-full flex flex-col justify-center text-center bg-black bg-no-repeat bg-cover text-white relative overflow-hidden">
